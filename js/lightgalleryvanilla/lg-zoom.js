                ...
                utils.on(image, 'touchstart', function (event) {
                    if (!tapped) {
                        ...
                        if(event.targetTouches.length < 2){
                            ...
                            var secondFinger = fingers[1];
                            var firstSide = secondFinger.screenX - firstFinger.screenX;
                            var secondSide = secondFinger.screenY - firstFinger.screenY;
                            var currentDistance = Math.sqrt( (firstSide*firstSide) + (secondSide*secondSide) );
